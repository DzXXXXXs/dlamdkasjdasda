...
function DiscordLib:Window(text)
	...
	EditBtn.MouseButton1Click:Connect(function()
		...
		Line.Name = "Line"
		Line.Parent = TextBoxFrame1
		Line.AnchorPoint = Vector2.new(0.5, 0.5)
		Line.BackgroundColor3 = Color3.fromRGB(64, 68, 73)
		Line.BorderSizePixel = 0
		Line.Position = UDim2.new(0.753000021, 0, 0.500999987, 0)
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Button(text,callback)
				...
				Button.BackgroundColor3 = Color3.fromRGB(23, 35, 42)
				...
				Button.MouseEnter:Connect(function()
					TweenService:Create(
						Button,
						TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(23, 35, 42)}
					):Play()
				end)
			...
			function ChannelContent:Toggle(text,default,callback)
                ...
                spawn(function()
                    while wait() do
                        pcall(function()
                            wait(0.1) 
                            game:GetService('TweenService'):Create(
                                ToggleFrame,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                                {BackgroundColor3 = Color3.fromRGB(255, 0, 0)}
                            ):Play() 
                            wait(.5)            
                            game:GetService('TweenService'):Create(
                                ToggleFrame,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                                {TextCBackgroundColor3olor3 = Color3.fromRGB(255, 155, 0)}
                            ):Play() 
                            wait(.5)            
                            game:GetService('TweenService'):Create(
                                ToggleFrame,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
				...
				Icon.Image = "http://www.roblox.com/asset/?id=6023426909"
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				GlowBubble.ZIndex = 0
				GlowBubble.Image = "rbxassetid://6023426909"
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				DropdownTitle.BackgroundColor3 = Color3.fromRGB(100, 100, 100 )
				...
				DropdownFrameOutline.BackgroundColor3 = Color3.fromRGB(255, 0, 0 )
                ...
                spawn(function()
                    while wait() do
                        pcall(function()
                            wait(0.1) 
                            game:GetService('TweenService'):Create(
                                DropdownFrameOutline,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                                {BackgroundColor3 = Color3.fromRGB(255, 0, 0)}
                            ):Play() 
                            wait(.5)            
                            game:GetService('TweenService'):Create(
                            ...
                            wait(.5)            
                            game:GetService('TweenService'):Create(
                                NamDropdownFrameOutlinee,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                                {BackgroundColor3 = Color3.fromRGB(0, 155, 255)}
                            ):Play() 
                            wait(.5)            
                            game:GetService('TweenService'):Create(
				...
				ArrowImg.Image = "http://www.roblox.com/asset/?id=4430392611"
				...
				function DropFunc:Add(textadd)
					...
					Item.Name = "Item"
					Item.Parent = DropItemHolder
					Item.BackgroundColor3 = Color3.fromRGB(0, 255, 23 )
					Item.Size = UDim2.new(0, 379, 0, 29)
					Item.AutoButtonColor = false
					Item.Font = Enum.Font.SourceSans
					Item.Text = ""
					...
					ItemText.Name = "ItemText"
					ItemText.Parent = Item
					ItemText.BackgroundColor3 = Color3.fromRGB(0, 255, 23)
					ItemText.BackgroundTransparency = 1.000
					ItemText.Position = UDim2.new(0.0211081803, 0, 0, 0)
					ItemText.Size = UDim2.new(0, 192, 0, 29)
					ItemText.Font = Enum.Font.Gotham
